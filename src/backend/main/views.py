...
def send_nearby(request):
	...
	for user in nearby_users:
		# new AIzaSyBF1Lq9aJnQannIRIpwcgRDuVDAN-jmzOk
		# old AIzaSyC0NDPBi5LbvZcF8J5g98uKAyMyoAojQBE
		distance_url = '''https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins=%s,%s&destinations=%s,%s&key=AIzaSyC7WVCOze50sNAoZxlFApQ4EV6hWsQWhKU''' % (user_p.lat, user_p.longitude, user.lat, user.longitude)
